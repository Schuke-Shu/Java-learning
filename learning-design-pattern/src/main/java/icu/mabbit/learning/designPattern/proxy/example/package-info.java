 ...
 *     在代理类{@link icu.mabbit.learning.designPattern.proxy.example.ProxySearcher}中实现对真实主题类的权限控制和引用计数，
 *     如果需要在访问真实主题时增加新的访问控制机制和新功能，只需增加一个新的代理类，再修改配置文件，在客户端代码中使用新增代理类即可，
 *     源代码无需修改，符合开闭原则
 *     </i>
 * </p>
 */
